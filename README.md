...
3.	Spájanie k¾úèovıch bodov (ang. keypoint matching)
...
S tımito hodnotami dokáeme deskriptor vizualizova. Takto sme pre kadı k¾úèovı bod vytvorili unikátny deskriptor,
 s pomocou ktorého vieme implementova poslednú èas algoritmu – spájanie k¾úèovıch bodov. 
...
Súvisiaci algoritmus je napríklad SURF, èo je vlastne jednoduchšia a rıchlejšia verzia algoritmu SIFT.
